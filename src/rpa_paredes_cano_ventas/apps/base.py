...
import _ctypes
from uiautomation import WindowControl,ButtonControl, SendKeys,GroupControl
...
class Process(ABC):
    ...
    @property
    def buttons_area(self) -> GroupControl:
    ...
    def export(self, save_dir: Path, file_name:str) -> Path:
